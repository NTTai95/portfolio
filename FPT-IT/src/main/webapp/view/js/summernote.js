        ...
        function ct(t, e, o) {
            ...
            if (n.length > 2) {
                ...
                if (i && 0 != e.offset && X(e)) {
                    var r,
                        a = i.nextSibling;
                    1 == a.nodeType ? ((n = V((r = a.childNodes[0]), g.eq(t))), (e = { node: r, offset: 0 })) : 3 != a.nodeType || a.data.match(/[\n\r]/g) || ((n = V((r = a), g.eq(t))), (e = { node: r, offset: 0 }));
                }
            }
                                ...
                                pt.walkPoint(
                                    ...
                                    function (e) {
                                        ...
                                        pt.isEditable(e.node) ||
                                            (n ? (pt.isLeftEdgePoint(e) && s.push(e.node), pt.isRightEdgePoint(e) && C.contains(s, e.node) && (i = e.node)) : (i = o ? pt.ancestor(e.node, t) : e.node), i && t(i) && a.push(i));
                                    },
                                    !0
                                ),
                                C.unique(a)
            ...
            return (
                ...
                (e = [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = this,
                                o = Tt.create(t).wrapBodyInlineWithPara(),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var o = this,
                                n = Tt.create(e).wrapBodyInlineWithPara(),
            ...
            oe = (function () {
                return (
                    (t = function t(e) {
                        ...
                        for (
                            var n = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor"],
                                i = 0,
                                a = n.length;
                            i < a;
                            i++
                                ...
                                r()
                                    ...
                                    .then(function (t) {
                                        n.beforeCommand(),
                                            ...
                                            n.setLastRange(Tt.createFromNodeAfter(t[0]).select()),
                                            n.afterCommand();
                                    })
                                    .fail(function (t) {
                                        ...
                                        this.ui.dropdown({
                                            ...
                                            callback: function (t) {
                                                t.find(".note-holder").each(function (t, e) {
                                                    var o = r()(e);
                                                    o.append(i.ui.palette({ colors: i.options.colors, colorsName: i.options.colorsName, eventName: o.data("event"), container: i.options.container, tooltip: i.options.tooltip }).render());
                                                });
                        ...
                        value: function () {
                            ...
                            this.context.memo("button.justifyLeft", g.invoke(i, "render")),
                                ...
                                this.context.memo("button.hr", function () {
                                    return t
                                        .button({ contents: t.ui.icon(t.options.icons.minus), tooltip: t.lang.hr.insert + t.representShortcut("insertHorizontalRule"), click: t.context.createInvokeHandler("editor.insertHorizontalRule") })
                                        .render();
                                }),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            for (var o = 0, n = e.length; o < n; o++) {
                                for (
                                    var i = e[o], r = Array.isArray(i) ? i[0] : i, a = Array.isArray(i) ? (1 === i.length ? [i[0]] : i[1]) : [i], s = this.ui.buttonGroup({ className: "note-" + r }).render(), l = 0, c = a.length;
                                    l < c;
                                    l++
                                ) {
                        ...
                        value: function (t, e) {
                            if (pt.isImg(t)) {
                                var o = r()(t).offset(),
                                    ...
                                    i = {};
                                this.options.popatmouse ? ((i.left = e.pageX - 20), (i.top = e.pageY)) : (i = o), (i.top -= n.top), (i.left -= n.left), this.$popover.css({ display: "block", left: i.left, top: i.top });
                            } else this.hide();
                        },
                    },
                    {
                            ...
                            if (o && 11 === o[1].length) {
                                ...
                                "undefined" !== u[6] && (P = u[6]),
                                    (e = r()('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">')
                                        .attr("frameborder", 0)
                                        .attr("src", "//" + u[1] + "/videos/embed/" + u[2] + "?loop=" + E + "&autoplay=" + T + "&muted=" + P + (S > 0 ? "&start=" + S : "") + (x > 0 ? "&end=" + b : ""))
                                        .attr("width", "560")
                                        .attr("height", "315"));
                        ...
                        value: function () {
                            ...
                            return Object.keys(e)
                                .map(function (o) {
                                    ...
                                    return i.append(r()("<label><kbd>" + o + "</kdb></label>").css({ width: 180, "margin-right": 10 })).append(r()("<span></span>").html(t.context.memo("help." + n) || n)), i.html();
                                })
                                .join("");
                        },
                    },
                        ...
                        value: function (t) {
                            ...
                            if (!e.range || (e.range.isCollapsed() && !t)) this.hide();
                                ...
                                var o = { left: this.pageX, top: this.pageY },
                                    n = r()(this.options.container).offset();
                                (o.top -= n.top), (o.left -= n.left), this.$popover.css({ display: "block", left: Math.max(o.left, 0) + -5, top: o.top + 5 }), this.context.invoke("buttons.updateCurrentStyle", this.$popover);
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            this.$popover.is(":visible") &&
                                (t.keyCode === Nt.code.ENTER ? (t.preventDefault(), this.replace()) : t.keyCode === Nt.code.UP ? (t.preventDefault(), this.moveUp()) : t.keyCode === Nt.code.DOWN && (t.preventDefault(), this.moveDown()));
                        },
                    },
                    {
                        key: "searchKeyword",
                    ...
                    return {
                        ...
                        palette: function (e, o) {
                            return Ko('<div class="note-color-palette"></div>', function (e, o) {
                                ...
                                e.html(n.join("")), o.tooltip && e.find(".note-color-btn").tooltip({ container: o.container || t.container, trigger: "hover", placement: "bottom" });
                            })(e, o);
                        },
                        button: function (e, o) {
                        ...
                        createLayout: function (e) {
                            ...
                            return (
                                o.insertAfter(e),
                                { note: e, editor: o, toolbar: o.find(".note-toolbar"), editingArea: o.find(".note-editing-area"), editable: o.find(".note-editable"), codable: o.find(".note-codable"), statusbar: o.find(".note-statusbar") }
                            );
                        },
