	...
	<div class="mb-4">
		<div class="d-flex">
			<div
				...
				<img class="w-100 h-100" src="/JAVA4_NEW/view/image/${param.avatar}"
					alt="Image">
			</div>
			<div class="flex-grow-1">
				<ul class="mb-1 ps-0">
					...
					<li class="d-inline-block float-end"><c:if
							...
							<jsp:include page="../userOption.jsp">
								...
								<jsp:param value="editCommentAnswer${param.answerId}"
									name="elEdit" />
								<jsp:param value="commentAnswerId${param.id}"
									name="commentTextId" />
								<jsp:param value="${param.id}" name="commentId" />
								<jsp:param value="/JAVA4_NEW/answers/comment/delete"
									name="hrefDelete" />
				...
				<p class="mb-0" id="commentAnswerId${param.id}">${param.content}</p>
			</div>
		</div>
	</div>
</div>